        ...
        <section className='text-black relative'>
          <div className='container px-6 py-5 mx-auto w-full'>
            <div className='flex flex-col text-center w-full mt-1'>
              <h1 className=' text-xl font-extrabold mb-2 text-white justify-center text-center text-opacity-95 transition-transform duration-500 hover:translate-x-5 hover:text-green-700 cursor-pointer'></h1>
            </div>
            <div className='lg:w-1/2 md:w-2/3 mx-auto'>
              <div className='flex flex-wrap -m-2'>
                ...
                <div className='p-2 w-full'>
                  <div className='relative'>
                    <label htmlFor='message' className='leading-7 text-sm text-opacity-95 font-extrabold'>Message:</label>
                ...
                <div className='p-2 w-full flex justify-center'>
                  <button className='inline-flex text-white bg-gradient-to-r from-blue-400 via-green-700 to-blue-700 border-0 py-2 px-8 focus:outline-none rounded-full text-lg'>Submit</button>
                </div>
