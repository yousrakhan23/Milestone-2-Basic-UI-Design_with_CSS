    ...
    <>
     ...
     <Image src={hero_section_img} alt={'hero_section_img'} className='rounded-lg shadow-lg w-50 h-50 object-cover ' />
      ...
      <div className="w-[90vw] h-[120vh] flex flex-wrap md:flex-nowrap justify-center items-center">
        ...
        <p className='mt-0 p-9 text-3xl text-green-900 font-extrabold uppercase translate-x-2 transition ease-in-out delay-150  hover:-translate-y-1 hover:scale-110  duration-300 '>one spray, total protection.<br /> Say goodbye to unwanted invaders with<br /><span className='text-blue-900'>Hexa Shield,</span> <br />the all-in-one solution for a pest-free home !</p>
        </div>

        <div className="grid grid-cols-1 gap-6 lg:w-1/2 mt-10 lg:mt-0 relative ">
          <Image src={hero_section_img} alt="hero-img" className="rounded-full border-spacing-0.5 bg-blue-900 shadow-lg w-50 h-50 object-cover p-10 flex-1 flex justify-end shadow-green-950 bg-gradient-to-r from-green-900 via-blue-900 to-green-900 " />
