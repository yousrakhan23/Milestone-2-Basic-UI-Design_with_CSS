...
const HeroSection = () => {
  return (
    ...
    <div>
      <div className="w-[90vw] h-[85vh] flex flex-wrap md:flex-nowrap justify-center items-center ">

        <div>

        <h1 className='mt-9 p-9  text-7xl text-blue-900 font-extrabold text-opacity-95 transition-transform duration-800 hover:translate-y-5 hover:text-green-800'>SAFE HOME CHEMICALS .</h1>
